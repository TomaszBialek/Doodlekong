package com.example.doodlekong.adapters
...
import com.example.doodlekong.databinding.ItemAnnouncementBinding
import com.example.doodlekong.databinding.ItemChatMessageIncomingBinding
import com.example.doodlekong.databinding.ItemChatMessageOutgoingBinding
import com.example.doodlekong.databinding.ItemRoomBinding
...
class ChatMessageAdapter(
    ...
    class IncomingChatMessageViewHolder(val binding: ItemChatMessageIncomingBinding): RecyclerView.ViewHolder(binding.root)

    class OutgoingChatMessageViewHolder(val binding: ItemChatMessageOutgoingBinding): RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when(viewType) {
            VIEW_TYPE_INCOMING_MESSAGE -> IncomingChatMessageViewHolder(
                ItemChatMessageIncomingBinding.inflate(LayoutInflater.from(parent.context), parent, false)
            )
            VIEW_TYPE_OUTGOING_MESSAGE-> OutgoingChatMessageViewHolder(
                ItemChatMessageOutgoingBinding.inflate(LayoutInflater.from(parent.context), parent, false)
            )
